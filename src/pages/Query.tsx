...
//             {!result.found ? (
//               /* NOT RELATED */
//               <div className="flex items-center text-yellow-700 bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
...
export default function Query() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setError(
        'Unable to process your question. Please make sure a document is uploaded.'
      );
    } finally {
      setLoading(false);
    }
